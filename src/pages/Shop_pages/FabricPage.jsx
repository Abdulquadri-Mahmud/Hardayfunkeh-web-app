  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        const filteredAbayas = data.filter((product) => product.category === "Fabric");
        ...
        <div className="bg-black mb-10 rounded-2xl relative">
          <div className="relative text-white flex flex-col items-center justify-center min-h-[300px] md:p-8 px-2 rounded-lg shadow-2xl overflow-hidden glass-card">
            ...
            <p className="text-lg text-center max-w-2xl">
              Discover our stunning collection of elegant jalabs, crafted with premium fabrics and intricate designs. Perfect for any occasion, our jalabs blend tradition with modern sophistication.
            </p>
          </div>
        </div>
