...
const wishlistsSlice = createSlice({
    ...
    reducers: {
        addWishlist : (state, action) => {
            const {productID, quantity, productName, stock, productPrice, productImage} = action.payload;
            ...
            if (findProductIndex >= 0) {
                ...
                state.wishlists.push({productID, quantity, stock, productName, productPrice, productImage});
